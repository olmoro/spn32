...
#define CONFIG_ALARM_MQTT_TSOP_UNKNOWN_TOPIC "rxIRnew"
#define CONFIG_ALARM_MQTT_TSOP_UNKNOWN_LOCAL 0
#define CONFIG_ALARM_MQTT_TSOP_UNKNOWN_QOS 0
#define CONFIG_ALARM_MQTT_TSOP_UNKNOWN_RETAINED 1
...
#define CONFIG_ALARM_PARAMS_FIX_TSOP_CODES_KEY "fix_tsop_codes"
#define CONFIG_ALARM_PARAMS_FIX_TSOP_CODES_FRIENDLY "Фиксировать новые TSOP коды"
