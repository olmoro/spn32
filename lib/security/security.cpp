...
void alarmInitDevices()
{
  ...
  ledQueue_t ledExec = nullptr;
    ...
    ledExec = ledTaskCreate(CONFIG_GPIO_EXEC_LED, true, true, "led_exec", CONFIG_LED_TASK_STACK_SIZE, nullptr);
  ...
  // Запускаем задачу             -exec-   -alarm-   -pult-
  alarmTaskCreate(siren, flasher, ledExec, ledAlarm, ledExec, nullptr);
